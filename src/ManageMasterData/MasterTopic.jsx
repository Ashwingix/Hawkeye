...
const MasterTopic = () => {
  ...
  const [colDefs, setColDefs] = useState([
    ...
    { field: "Chapter", resizable: true, minWidth: 150 },
    {  headerName: "Topic Name",field: "name", resizable: true, minWidth: 150 },
  ...
  useEffect(() => {
    const fetchData = async () => {
      const apiUrl = "http://3.109.144.250/phase3/api/v1/topic/list";
